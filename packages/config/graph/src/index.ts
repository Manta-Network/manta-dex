...
export const SQUID_HOST: Record<number | string, string> = {
  ...
  [ParachainId.MANTA_POLKADOT]: `${SQUID_HOST_ENDPOINT}/manta-dex-manta-debug-squid/v/v4/graphql`,
}
...
export const ARCHIVE_HOST: Record<number | string, string> = {
  ...
  [ParachainId.MANTA_POLKADOT]: 'https://dev.manta-debug.graphql.nonprod-mantadex.com/graphql',
}
