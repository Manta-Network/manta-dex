...
import { Container, DiscordIcon, GithubIcon, Link, MantaDEXIcon, MantaWalletIcon, TwitterIcon, Typography, ZenlinkIcon } from '..'
  ...
  },
  {
    ...
    items: [
      ...
      // },
      {
        ...
        href: 'https://mantadex.medium.com/',
        target: '_blank',
        rel: 'noopener noreferrer',
      },
      // {
      ...
      // },
      {
        ...
        href: 'https://twitter.com/MantaDex',
        target: '_blank',
        rel: 'noopener noreferrer',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        msgId: 'GitHub',
        name: 'GitHub',
        href: 'https://github.com/MantaDEX',
        target: '_blank',
        rel: 'noopener noreferrer',
      },
    ],
      ...
      <Container maxWidth="5xl" className="grid grid-cols-1 md:grid-cols-[176px_auto] mx-auto px-4 gap-4">
        <div className="flex flex-col gap-5">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/MantaDEX" target="_blank" rel="noopener noreferrer">
              <GithubIcon width={16} className="text-slate-700 dark:text-slate-300 hover:text-slate-500 hover:dark:text-slate-50" />
            </a>
            <a href="https://twitter.com/MantaDEX" target="_blank" rel="noopener noreferrer">
